...
INTSET = INTF_SETCLR!INTF_INTEN!INTF_EXTER!INTF_VERTB
*INTSET = $e02c
MAX_VPOS_FOR_BG_TASK = 280
RANDOM_SEED = $79ec1f29

_start:
		include	"include/PhotonsMiniWrapper1.04.i"
...
.noPre:
		...
		; Start music
		lea		Music_Score,a0
		lea.l	Music_Samples,a1
		sub.l	a2,a2							* VBR from MiniWrapper?
		moveq	#0,d0
		move.w	#DMAF_SETCLR!DMAF_MASTER,dmacon(a6)
...
; Restore standard DMA and interrupt
		move.w	#DMAF_SPRITE!DMAF_BLITHOG,dmacon(a6) * turn sprite and blithog off by default
		move.w	#INTF_COPER!INTF_BLIT,intena(a6) * turn COPER and BLIT off. each effect may use them, but default is off
		move.w	#DMASET,dmacon(a6)
		move.w	#INTSET,intena(a6)
...
; skip to next part
		...
		tst.w	SkipPressed						* P61_Pos							*** fix here???
		rts
.noPressed:
		clr.w	SkipPressed
.checkFrame:
...
SetBgTask:
		cmp.l	#0,a0
		beq.s	.noBgTaskError					; exit if no task is given
		lea		BgStackE(pc),a1
...
FillData: dcb.w	16,$fff
		...
		include	"include/LightSpeedPlayer.i"
		include	"include/LightSpeedPlayer_cia.i"
			

Music_Score: incbin "assets/funky_vibes.lsmusic"
...
*Music_Samples: incbin "assets/funky_vibes.lsbank"
Music_Samples: incbin "assets/funky_vibes.lsbank"
...
BlankCop:
		...
		dc.w	diwstop,$2cc1
		dc.w	bplcon0,$0200
		dc.w	fmode,0,bplcon3,$0c00,bplcon4,$0011
		dc.w	color00
BlankBg	dc.w	0
		dc.l	-2
